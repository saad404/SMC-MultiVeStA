...
public class ARGoSState extends NewState {
	...
	private native double observeARGoS(String observation);
	...
	public double rval(String observation) {
		if (observation.equals("time")) {
			return getTime();
		} else if (observation.equals("steps")) {
			return getNumberOfSteps();
		} else if (observation.equals("finished")) {
			return getIsSimulationFinished() ? 1.0 : 0.0;
		} else {
		// Should currently return xpos,ypos
